...
struct base {
    ...
    std::shared_ptr<property::generic> properties;
    ...
    */
    ...
    std::shared_ptr<property::generic> add_property(const string_type& name_in, const property::value_type& type_in);
    std::shared_ptr<property::generic> add_property(const string_type& name_in, std::shared_ptr<property::generic> property_in);
    ...
    const property::pmap_type& get_properties();
    std::shared_ptr<property::generic> get_property(const string_type& name_in);
